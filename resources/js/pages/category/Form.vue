                ...
                <form @submit.prevent="handleSubmit" class="space-y-6">
                    <div>
                        ...
                        <Input id="name" v-model="form.name" type="text" placeholder="Masukkan nama kategori"
                            :error="form.errors.name" class="mt-1 block w-full" />
                    ...
                    <div>
                        ...
                        <Input id="img" v-model="form.img" type="text" placeholder="Masukkan URL gambar (opsional)"
                            :error="form.errors.img" class="mt-1 block w-full" />
                        <div v-if="form.errors.img" class="text-red-500 text-sm mt-1">{{ form.errors.img }}</div>
                    </div>
                </form>
            </CardContent>
